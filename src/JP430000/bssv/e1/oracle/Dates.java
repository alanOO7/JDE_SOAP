...
public class Dates  extends JP430000.bssv.e1.oracle.ValueObject  implements java.io.Serializable {
    ...
    /**
     * Gets the datePromisedDelivery value for this Dates.
     * 
    ...
    /**
     * Sets the datePromisedDelivery value for this Dates.
     * 
    ...
    /**
     * Gets the dateRequested value for this Dates.
     * 
    ...
    /**
     * Sets the dateRequested value for this Dates.
     * 
     * @param dateRequested
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://oracle.e1.bssv.JP430000/", "dates"));
